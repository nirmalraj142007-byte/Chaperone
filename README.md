...
replaced with the full write-up — architecture, setup, the measured drift
number, and the demo — as those exist.

## Status

Documents only, no application code yet. See [`CRAWL_DATES.md`](CRAWL_DATES.md),
[`corpus/TAXONOMY.md`](corpus/TAXONOMY.md), [`corpus/PREDICTIONS.md`](corpus/PREDICTIONS.md),
